<%-- 
    Document   : materiaskist
    Created on : 28-06-2019, 17:14:13
    Author     : Cesar
--%>
          ...
          <div class="row">
            <div class="col-md-6">
                <form action="srvmaterias" method="post">
                   ...
                   <label>Seleccion Producto: </label>
            <select name="MateriaSeleccionado">
                <c:forEach items="${listadomaterias}" var="p">
                    <option value="${p.matcodigo}">${p.matnombre}</option>
                </c:forEach>
            </select>
